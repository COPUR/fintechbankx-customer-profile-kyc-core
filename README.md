...
- **Tribe:** Customer & Trust Tribe
- **Squad:** Customer Profile & KYC Squad
- **Repo Kümesi:** `customer-core`
- **Bounded Context:** `customer`
- **Ana Capability:** Customer profile and KYC domain services
- **Dönüşüm Wave:** 4
...
- `Customer profile and KYC domain services` kapsamında kod, sözleşme, test, runbook ve release artefaktları.
